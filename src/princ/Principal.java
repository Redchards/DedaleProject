...
import princ.Scenario.SCENARIO;
		...
		for(int i=0; i<scenario.numberOfExplorerAgents;i++) {
			...
			try {
				Object[] explorerAgentsParameters	= new Object[]{env,
						...
						(scenario.numberOfExplorerMap == -1 || (scenario.numberOfExplorerMap - i > 0)) ? true : false,
						(scenario.numberOfExplorerLog == -1 || (scenario.numberOfExplorerLog - i > 0)) ? true : false
						};
				AgentController	ag=c.createNewAgent(agentName,ExplorerAgent.class.getName(), explorerAgentsParameters);
				agentList.add(ag);
				System.out.println(agentName+" launched");
			} catch (StaleProxyException e) { e.printStackTrace(); }
		}
		...
		for(int i=0; i<scenario.numberOfTankerAgents;i++) {
			...
			try {
				Object[] tankerAgentsParameters	= new Object[]{env,
						...
						(scenario.numberOfTankerMap == -1 || (scenario.numberOfTankerMap - i > 0)) ? true : false,
						(scenario.numberOfTankerLog == -1 || (scenario.numberOfTankerLog - i > 0)) ? true : false
						};
				AgentController	ag=c.createNewAgent(agentName,TankerAgent.class.getName(), tankerAgentsParameters);
				agentList.add(ag);
				System.out.println(agentName+" launched");
			} catch (StaleProxyException e) { e.printStackTrace(); }
		}
		...
		for(int i=0; i<scenario.numberOfCollectorAgents;i++) {
			...
			try {
				Object[] collectorAgentsParameters	= new Object[]{env,
						...
						(scenario.numberOfCollectorMap == -1 || (scenario.numberOfCollectorMap - i > 0)) ? true : false,
						(scenario.numberOfCollectorLog == -1 || (scenario.numberOfCollectorLog - i > 0)) ? true : false
						};
				AgentController	ag=c.createNewAgent(agentName,CollectorAgent.class.getName(), collectorAgentsParameters);
				agentList.add(ag);
				System.out.println(agentName+" launched");
			} catch (StaleProxyException e) { e.printStackTrace(); }
		}
